...
Сравните различия между рабочей директорией и последним коммитом с помощью команды `git diff`. Она покажет вам изменения в файлах, которые еще не добавлены для коммита.